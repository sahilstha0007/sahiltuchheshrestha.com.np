...
const CareerCard = ({
  ...
  const formattedStartDate = startDate ? format(startDate, "MMM yyyy") : "Invalid Date";
  const formattedEndDate = endDate ? format(endDate, "MMM yyyy") : "Present";

  const durationYears = startDate && endDate ? differenceInYears(endDate, startDate) : 0;
  const durationMonths = startDate && endDate ? differenceInMonths(endDate, startDate) % 12 : 0;
