...
const Portfolio = () => {
  ...
  const PORTFOLIO_URL =
    "https://www.canva.com/design/DAGljpjzJz8/Yrx0tzijUA4aUavZDPyTUA/view?utm_content=DAGljpjzJz8&utm_campaign=designshare&utm_medium=link2&utm_source=uniquelinks&utlId=h880689aa5e";
